...
if __name__=='__main__':
    ...
    cfg.training.denoising_model.seed = cfg.seed
    cfg.training.waiting_time_predictor_model.seed = cfg.seed
    ...
    if args.overrides=='':
        ...
        run_folder_name = f"c{cfg.cond_value}_n{cfg.num_samples}_t{cfg.temperature}_iter{cfg.iteration}_seed{cfg.seed}"
